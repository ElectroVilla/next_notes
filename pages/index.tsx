...
const Home = ({ notes } : Notes) => {
  ...
  return (
    ...
    <div>
       <h1 className="text-center font-bold text-2xl mt-4">Notes</h1><br />
       <form onSubmit={e => {
        e.preventDefault()
        // handleSubmit(form)
        create(form)
      ...
      <div className="w-auto min-w-[30%] max-w-min mt-20 mx-auto space-y-6 flex flex-col items-stretch">
        <ul>
          {notes.map(note => (
